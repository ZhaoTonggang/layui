      ...
      ,"data": [
        {
          "alt": "layer友情打赏",
          "pid": 666, //图片id
          "src": "../res/images/pay/layer.jpg"/*tpa=http://res.layui.com/images/pay/layer.jpg*/, //原图地址
          "thumb": "" //缩略图地址
        }
      ]
    }
  ...
  if(!notLayuiAdmin && false){
    layer.open({
      ...
      ,content: ['<div style="padding: 15px; text-align: center; background-color: #e2e2e2;">'
        ,'<a href="https://www.baidu.com/" target="_blank"><img src="../res/upload/2018_5/168_1527691799254_76462.jpg"/*tpa=http://cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg*/ alt="layuiAdmin" style="width: 100%; height:149.78px;"></a>'
      ,'</div>'].join('')
      ,success: function(layero, index){
